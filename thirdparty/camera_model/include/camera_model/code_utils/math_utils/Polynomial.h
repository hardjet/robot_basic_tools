...
class Polynomial {
 ...
 private:
  ...
  // _y = f(x)
  bool FindRoots(const double y, const eigen_utils::Vector& polynomial_in, eigen_utils::Vector& real,
                 eigen_utils::Vector& imaginary);

  void FindLinearPolynomialRoots(const eigen_utils::Vector& Polynomial, eigen_utils::Vector& real,
                                 eigen_utils::Vector& imag);

  void FindQuadraticPolynomialRoots(const eigen_utils::Vector& Polynomial, eigen_utils::Vector& real,
                                    eigen_utils::Vector& imag);
