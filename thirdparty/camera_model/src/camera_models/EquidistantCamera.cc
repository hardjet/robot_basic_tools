...
void EquidistantCamera::liftProjective(const Eigen::Vector2d& p, Eigen::Vector3d& P, float image_scale) const {
...
void EquidistantCamera::spaceToPlane(const Eigen::Vector3d& P, Eigen::Vector2d& p, float image_scalse) const {
...
cv::Size EquidistantCamera::imageSize() const { return cv::Size(imageWidth(), imageHeight()); }
}  // namespace camera_model
