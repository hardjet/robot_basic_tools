    ...
    case CAMERA_POSE:
      switch (camera->modelType()) {
        case Camera::KANNALA_BRANDT:
          costFunction = new ceres::AutoDiffCostFunction<ReprojectionError1<EquidistantCamera>, 2, 4, 3>(
              new ReprojectionError1<EquidistantCamera>(intrinsic_params, observed_P, observed_p));
          break;
        case Camera::PINHOLE:
          costFunction = new ceres::AutoDiffCostFunction<ReprojectionError1<PinholeCamera>, 2, 4, 3>(
              new ReprojectionError1<PinholeCamera>(intrinsic_params, observed_P, observed_p));
          break;
        case Camera::PINHOLE_FULL:
          costFunction = new ceres::AutoDiffCostFunction<ReprojectionError1<PinholeFullCamera>, 2, 4, 3>(
              new ReprojectionError1<PinholeFullCamera>(intrinsic_params, observed_P, observed_p));
          break;
        case Camera::MEI:
          costFunction = new ceres::AutoDiffCostFunction<ReprojectionError1<CataCamera>, 2, 4, 3>(
              new ReprojectionError1<CataCamera>(intrinsic_params, observed_P, observed_p));
          break;
        case Camera::SCARAMUZZA:
          costFunction = new ceres::AutoDiffCostFunction<ReprojectionError1<OCAMCamera>, 2, 4, 3>(
              new ReprojectionError1<OCAMCamera>(intrinsic_params, observed_P, observed_p));
          break;
        case Camera::POLYFISHEYE:
          costFunction = new ceres::AutoDiffCostFunction<ReprojectionError1<PolyFisheyeCamera>, 2, 4, 3>(
              new ReprojectionError1<PolyFisheyeCamera>(intrinsic_params, observed_P, observed_p));
          break;
        case Camera::SPLINE:
          costFunction = new ceres::AutoDiffCostFunction<ReprojectionError1<SplineCamera>, 2, 4, 3>(
              new ReprojectionError1<SplineCamera>(intrinsic_params, observed_P, observed_p));
          break;
        case Camera::FOV:
          costFunction = new ceres::AutoDiffCostFunction<ReprojectionError1<FovCamera>, 2, 4, 3>(
    ...
    case CAMERA_INTRINSICS | CAMERA_POSE:
      switch (camera->modelType()) {
        ...
        case Camera::POLYFISHEYE:
          ...
          break;
        case Camera::SPLINE:
          costFunction = new ceres::AutoDiffCostFunction<ReprojectionError1<SplineCamera>, 2, SPLINE_PARAMS_NUM, 4, 3>(
              new ReprojectionError1<SplineCamera>(observed_P, observed_p));
          break;
        case Camera::FOV:
          costFunction = new ceres::AutoDiffCostFunction<ReprojectionError1<FovCamera>, 2, FOV_PARAM_NUM, 4, 3>(
    ...
    case CAMERA_ODOMETRY_TRANSFORM | ODOMETRY_6D_POSE:
      switch (camera->modelType()) {
        ...
        case Camera::SCARAMUZZA:
          ...
          break;
        case Camera::POLYFISHEYE:
          costFunction = new ceres::AutoDiffCostFunction<ReprojectionError1<PolyFisheyeCamera>, 2, 4, 3, 3, 3>(
              new ReprojectionError1<PolyFisheyeCamera>(intrinsic_params, observed_P, observed_p));
          break;
        case Camera::SPLINE:
