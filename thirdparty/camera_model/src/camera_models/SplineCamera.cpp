...
SplineCamera::SplineCamera() : m_inv_K11(1.0), m_inv_K12(0.0), m_inv_K13(0.0), m_inv_K22(1.0), m_inv_K23(0.0) {
...
SplineCamera::SplineCamera(const std::string& cameraName, int imageWidth, int imageHeight, double k2, double k3,
                           double k4, double k5, double k6, double k7, double p1, double p2, double A11, double A12,
...
SplineCamera::SplineCamera(const SplineCamera::Parameters& params) : mParameters(params) {
  eigen_utils::Vector coeff(FISHEYE_POLY_ORDER + 1);
...
Camera::ModelType SplineCamera::modelType() const { return mParameters.modelType(); }

const std::string& SplineCamera::cameraName() const { return mParameters.cameraName(); }

int SplineCamera::imageWidth() const { return mParameters.imageWidth(); }

int SplineCamera::imageHeight() const { return mParameters.imageHeight(); }

void SplineCamera::spaceToPlane(const Eigen::Vector3d& P, Eigen::Vector2d& p) const {
  ...
  if (mParameters.isDistortion()) {
    if (mParameters.isFast() == 1) {
      ...
      Eigen::Vector2d du = Eigen::Vector2d(2.0 * mParameters.p1() * u * v + mParameters.p2() * (r_point + 2.0 * u * u),
...
void SplineCamera::spaceToPlane(const Eigen::Vector3d& P, Eigen::Vector2d& p, float image_scalse) const {
 ...
 */
void SplineCamera::spaceToPlane(const Eigen::Vector3d& P, Eigen::Vector2d& p, Eigen::Matrix<double, 2, 3>& J) const {
  double theta = acos(P(2) / P.norm());
  double inverse_r_P2 = 1.0 / sqrt(P(1) * P(1) + P(0) * P(0));
  double sin_phi = P(1) * inverse_r_P2;
  double cos_phi = P(0) * inverse_r_P2;
...
void SplineCamera::estimateIntrinsics(const cv::Size& boardSize,
...
void SplineCamera::liftSphere(const Eigen::Vector2d& p, Eigen::Vector3d& P) const { liftProjective(p, P); }

void SplineCamera::rayToPlane(const Ray& ray, Eigen::Vector2d& p) const {
...
void SplineCamera::liftProjectiveToRay(const Eigen::Vector2d& p, Ray& ray) const {
  // TODO
...
void SplineCamera::liftProjective(const Eigen::Vector2d& p, Eigen::Vector3d& P) const {
...
void SplineCamera::liftProjective(const Eigen::Vector2d& p, Eigen::Vector3d& P, float image_scale) const {
...
void SplineCamera::undistToPlane(const Eigen::Vector2d& p_u, Eigen::Vector2d& p) const {}

cv::Mat SplineCamera::initUndistortRectifyMap(cv::Mat& map1, cv::Mat& map2, float fx, float fy, cv::Size imageSize,
...
int SplineCamera::parameterCount() const { return SPLINE_PARAMS_NUM; }

const SplineCamera::Parameters& SplineCamera::getParameters() const { return mParameters; }

void SplineCamera::setParameters(const SplineCamera::Parameters& parameters) {
...
void SplineCamera::readParameters(const std::vector<double>& parameterVec) {
...
void SplineCamera::writeParameters(std::vector<double>& parameterVec) const {
...
void SplineCamera::writeParametersToYamlFile(const std::string& filename) const {
  mParameters.writeToYamlFile(filename);
}

std::string SplineCamera::parametersToString() const {
...
void SplineCamera::backprojectSymmetric(const Eigen::Vector2d& p_u, double& cos_theta, double& sin_theta,
...
bool SplineCamera::calcKinvese(double a11, double a12, double a22, double u0, double v0) {
...
void SplineCamera::setPoly(math_utils::Polynomial* value) { poly = value; }

SplineCamera::FastCalcTABLE* SplineCamera::getFastCalc() { return fastCalc; }

void SplineCamera::setFastCalc() {
...
double SplineCamera::getInv_K23() const { return m_inv_K23; }

double SplineCamera::getInv_K22() const { return m_inv_K22; }

double SplineCamera::getInv_K13() const { return m_inv_K13; }

double SplineCamera::getInv_K12() const { return m_inv_K12; }

double SplineCamera::getInv_K11() const { return m_inv_K11; }

math_utils::Polynomial* SplineCamera::getPoly() const { return poly; }
...
SplineCamera::Parameters::Parameters(const std::string& cameraName, int w, int h, double k2, double k3, double k4,
...
double& SplineCamera::Parameters::k2() { return m_k2; }

double& SplineCamera::Parameters::k3() { return m_k3; }

double& SplineCamera::Parameters::k4() { return m_k4; }

double& SplineCamera::Parameters::k5() { return m_k5; }

double& SplineCamera::Parameters::k6() { return m_k6; }

double& SplineCamera::Parameters::k7() { return m_k7; }

double& SplineCamera::Parameters::p1() { return m_p1; }

double& SplineCamera::Parameters::p2() { return m_p2; }

double& SplineCamera::Parameters::A11() { return m_A11; }

double& SplineCamera::Parameters::A12() { return m_A12; }

double& SplineCamera::Parameters::A22() { return m_A22; }

double& SplineCamera::Parameters::u0() { return m_u0; }

double& SplineCamera::Parameters::v0() { return m_v0; }

int& SplineCamera::Parameters::numDiff() { return m_numDiff; }

int& SplineCamera::Parameters::maxIncidentAngle() { return m_maxIncidentAngle; }

int& SplineCamera::Parameters::isFast() { return m_isFast; }

double SplineCamera::Parameters::k2() const { return m_k2; }

double SplineCamera::Parameters::k3() const { return m_k3; }

double SplineCamera::Parameters::k4() const { return m_k4; }

double SplineCamera::Parameters::k5() const { return m_k5; }

double SplineCamera::Parameters::k6() const { return m_k6; }

double SplineCamera::Parameters::k7() const { return m_k7; }

double SplineCamera::Parameters::p1() const { return m_p1; }

double SplineCamera::Parameters::p2() const { return m_p2; }

double SplineCamera::Parameters::A11() const { return m_A11; }

double SplineCamera::Parameters::A12() const { return m_A12; }

double SplineCamera::Parameters::A22() const { return m_A22; }

double SplineCamera::Parameters::u0() const { return m_u0; }

double SplineCamera::Parameters::v0() const { return m_v0; }

int SplineCamera::Parameters::isFast() const { return m_isFast; }

int SplineCamera::Parameters::numDiff() const { return m_numDiff; }

int SplineCamera::Parameters::maxIncidentAngle() const { return m_maxIncidentAngle; }

void SplineCamera::Parameters::setFast() { m_isFast = 1; }

bool SplineCamera::Parameters::readFromYamlFile(const std::string& filename) {
...
bool SplineCamera::Parameters::isDistortion() const { return (m_k2 != 0.0); }

void SplineCamera::Parameters::writeToYamlFile(const std::string& filename) const {
...
SplineCamera::Parameters& SplineCamera::Parameters::operator=(const SplineCamera::Parameters& other) {
  if (this != &other) {
...
std::ostream& operator<<(std::ostream& out, const SplineCamera::Parameters& params) {
...
void SplineCamera::FastCalcTABLE::setMaxIncidentAngle(double value) {
  maxIncidentAngle = value;
  resetFastCalc();
}

void SplineCamera::FastCalcTABLE::setNumDiffAngle(int value) {
  numDiffAngle = value;
  resetFastCalc();
}

void SplineCamera::FastCalcTABLE::setMaxImageR(double value) {
  maxImageR = value;
  resetFastCalc();
}

void SplineCamera::FastCalcTABLE::setNumDiffR(int value) {
  numDiffR = value;
  resetFastCalc();
}

eigen_utils::Matrix SplineCamera::FastCalcTABLE::getMatAngleToR() { return angleToR; }

eigen_utils::Matrix SplineCamera::FastCalcTABLE::getMatRToAngle() { return rToAngle; }

double SplineCamera::FastCalcTABLE::getMaxIncidentAngle() { return maxIncidentAngle; }

int SplineCamera::FastCalcTABLE::getNumDiff() { return numDiffR; }

double SplineCamera::FastCalcTABLE::getDiffAngle() { return diffAngle; }

double SplineCamera::FastCalcTABLE::getDiffR() { return diffR; }

bool SplineCamera::FastCalcTABLE::calcAngleToR(eigen_utils::Matrix& _angleToR, const int _numDiffAngle,
...
bool SplineCamera::FastCalcTABLE::calcRToAngle(eigen_utils::Matrix& _rToAngle, const int _numDiffR, const double _diffR,
...
void SplineCamera::FastCalcTABLE::backprojectSymmetric(const Eigen::Vector2d& p_u, double& cos_theta, double& sin_theta,
                                                       double& cos_phi, double& sin_phi) const {
  double r = p_u.norm();
  double theta;
...
double SplineCamera::FastCalcTABLE::r(const double theta) const {
...
void SplineCamera::FastCalcTABLE::resetFastCalc() {
...
void SplineCamera::FastCalcPOLY::backprojectSymmetric(const Eigen::Vector2d& p_u, double& cos_theta, double& sin_theta,
                                                      double& cos_phi, double& sin_phi) const {
  double r = p_u.norm();
  //  std::cout << "#INFO: r is " << r << std::endl;
...
double SplineCamera::FastCalcPOLY::r(const double theta) const {
  if (theta > 1e-10 && theta < maxIncidentAngle) {
...
void SplineCamera::FastCalcPOLY::setMaxIncidentAngle(double value) {
  maxIncidentAngle = value;
  resetFastCalc();
}

void SplineCamera::FastCalcPOLY::setMaxImageR(double value) {
  maxImageR = value;
  resetFastCalc();
}

void SplineCamera::FastCalcPOLY::resetFastCalc() {
